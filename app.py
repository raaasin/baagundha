...
def process_image():
    ...
    response = model.generate_content(
        ["Read all contents of the label, based on all contents rate it out of 5 for edible products using the Health Star Rating (HSR) system and for inedible products like groceries or makeup tell about safe usage etc,reply like this: rating:, reason:, expiry:, reply in json format", picture],
